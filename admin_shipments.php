    ...
    <div class="content" id="mainContent">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card h-100 border-start border-4 border-danger">
                    <div class="kpi-card-body">
                        ...
                        <div class="kpi-icon bg-soft-danger"><i class="bi bi-exclamation-triangle text-danger"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow mb-4">
            <div
                ...
                <button class="btn btn-sm btn-light border" onclick="location.reload()"><i
            ...
            <div class="table-responsive p-0">
                <table class="table table-hover align-middle mb-0 w-100">
                    ...
                    <tbody>
                                ...
                                <tr>
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center">
                                            <div class="rounded-circle bg-light d-flex justify-content-center align-items-center me-3 text-secondary"
                                                style="width: 35px; height: 35px;">
                                                <i class="bi bi-box"></i>
                                            </div>
                                            <div>
                                                <span
                                                    class="d-block fw-bold text-primary font-mono"><?php echo $row['contract_number']; ?></span>
                                    ...
                                    <td>
                                        <div class="route-visual">
                                            ...
                                            <div class="text-xs text-muted mt-1"><?php echo $row['destination_address']; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <small class="text-muted" style="font-size: 11px;">Booked:
                                                <?php echo date('M d', $book_date); ?></small>
                                            <small class="fw-bold text-dark" style="font-size: 11px;">Target:
                                                <?php echo date('M d', $target_date); ?></small>
                                            <small class="text-muted fst-italic"
                                                style="font-size: 10px;"><?php echo $sla_days; ?> Days SLA</small>
                                        </div>
                                    </td>
                                    <td>
                                        <?php
                                        ...
                                        elseif ($current_status == 'CONSOLIDATED')
                                            $badgeClass = 'bg-soft-info';
                                        elseif ($current_status == 'IN_TRANSIT' || $current_status == 'DISPATCH')
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="btn-group">
                                            <button onclick="syncStatus('<?php echo $row['contract_number']; ?>', this)"
                                                class="btn btn-sm btn-outline-primary rounded-pill px-3"
                                                title="Sync Status from Core 1">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7" class="text-center py-5 text-muted">No shipments found.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
