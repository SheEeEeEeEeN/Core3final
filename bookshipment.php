...
if ($input && $_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  try {
    ...
    mysqli_query($conn, "UPDATE shipments SET shipment_code = '" . mysqli_real_escape_string($conn, $trackingCode) . "' WHERE id = '$shipmentId'");
    ...
    logShipmentEvent(
      ...
      'Pending',
      $origin,
      'Shipment booking created and waiting for consolidation.'
    );
  ...
  <style>
    ...
    * {
    ...
    body.dark-mode .form-control:focus {
      ...
      box-shadow: 0 0 0 4px rgba(34, 40, 49, 0.3);
    }
    ...
    document.getElementById("finalConfirmBtn").addEventListener("click", async function(e) { // <--- Lagyan mo ng 'e'
      ...
      try {
        ...
        if (result.success) {
          ...
          const waybillLink = "generate_waybill.php?id=" + result.shipment_id;
          ...
          Swal.fire({
            ...
            html: `
              ...
              <div class="d-grid gap-2 mt-3">
                <a href="${waybillLink}" target="_blank" class="btn btn-dark">
                  <i class="bi bi-upc-scan"></i> Generate Waybill
                </a>
        ...
        Swal.fire({
          ...
          text: 'Unable to submit booking. Please check your connection.',
          confirmButtonColor: '#dc3545'
        });
      }
    });
