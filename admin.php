...
while ($row = $rStat->fetch_assoc()) {
    if ($row['status'] == 'Pending')
        $statusCounts[0] = $row['c'];
    if ($row['status'] == 'In Transit' || $row['status'] == 'Out for Delivery')
        $statusCounts[1] += $row['c'];
    if ($row['status'] == 'Delivered')
        $statusCounts[2] = $row['c'];
    if ($row['status'] == 'Cancelled')
        $statusCounts[3] = $row['c'];
}
    ...
    <div class="content" id="mainContent">
                ...
                <div class="card h-100 py-2 border-start border-4 border-primary">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs fw-bold text-primary text-uppercase mb-1">Total Revenue (Delivered)
                                </div>
                                <div class="h5 mb-0 fw-bold text-gray-800">₱<?php echo number_format($totalRevenue); ?>
                                </div>
                            </div>
                            <div class="col-auto"><i class="bi bi-currency-dollar fs-2 text-primary opacity-50"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card h-100 py-2 border-start border-4 border-warning">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto"><i class="bi bi-clipboard-data fs-2 text-warning opacity-50"></i>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col ps-2">
                                        <div class="progress progress-sm mr-2" style="height: 5px;">
                                            <div class="progress-bar bg-info" role="progressbar"
                                                style="width: <?php echo $slaRate; ?>%"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-lg-8">
                <div class="card shadow h-100">
                    <div
                        class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom align-items-center">
        ...
        <div class="row g-3">
            <div class="col-lg-8">
                <div class="card shadow h-100">
                    <div
                        class="card-header py-3 bg-transparent border-bottom d-flex justify-content-between align-items-center">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                <?php if ($recShip->num_rows > 0):
                                    while ($row = $recShip->fetch_assoc()): ?>
                                        <tr>
                                            <td class="ps-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="rounded-circle bg-light d-flex justify-content-center align-items-center me-3 text-primary"
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center text-secondary">
                                                    ...
                                                    <span
                                                        class="text-sm fw-bold"><?php echo substr($row['destination_address'], 0, 18) . '...'; ?></span>
                                                </div>
                                            </td>
                                            <td>
                                                <?php
                                                ...
                                                ?>
                                                <span
                                                    class="badge <?php echo $badgeClass; ?> px-3 py-2 rounded-pill border border-0 fw-bold">
                                                    <?php echo $st; ?>
                                                </span>
                                            </td>
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span
                                                        class="fw-bold text-dark">₱<?php echo number_format($row['price']); ?></span>
                                            ...
                                            <td class="text-end pe-4">
                                                ...
                                                <a href="view_shipment.php?id=<?php echo $row['id']; ?>"
                                                    class="text-secondary text-hover-primary">
                            ...
                            while ($f = $feedbacks->fetch_assoc()): ?>
                                <div class="list-group-item border-bottom-0 pb-3 pt-3">
                                    <div class="d-flex w-100 justify-content-between align-items-center mb-1">
                                        <h6 class="mb-0 fw-bold text-dark small"><?php echo htmlspecialchars($f['username']); ?>
                                        </h6>
                                        <small class="text-muted"
                                            style="font-size: 10px;"><?php echo time_elapsed_string($f['created_at']); ?></small>
                                    </div>
                                    <div class="text-warning small mb-2" style="font-size: 10px;">
                                        <?php for ($i = 0; $i < $f['rating']; $i++)
                                            echo '<i class="bi bi-star-fill"></i> '; ?>
                                    </div>
                                    <p class="mb-0 small text-secondary bg-light p-2 rounded fst-italic">
                                        "<?php echo $f['feedback_text'] ?: 'No comment'; ?>"</p>
                                </div>
                            <?php endwhile; else: ?>
