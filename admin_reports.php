...
if ($count > 0) $avgOrderValue = $totalSales / $count;
?>
                ...
                <div class="stat-card card h-100 border-start border-4 border-primary">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <div class="h3 mb-0 fw-bold text-gray-800">₱<?php echo number_format($totalSales, 2); ?></div>
                        </div>
                ...
                <div class="stat-card card h-100 border-start border-4 border-info">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <div class="h3 mb-0 fw-bold text-gray-800">₱<?php echo number_format($avgOrderValue, 2); ?></div>
                        </div>
                ...
                <table class="table table-hover align-middle mb-0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <span class="fw-bold text-dark"><?php echo date('M d, Y', strtotime($row['created_at'])); ?></span>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        ...
                                        <small class="text-muted"><i class="bi bi-geo-alt me-1"></i><?php echo $row['destination_island']; ?></small>
                                    </div>
                                </td>
                                <td>
                                    <?php 
                                        ...
                                        if($s=='Delivered') $badgeClass = 'badge-soft-success';
                                        if($s=='Cancelled') $badgeClass = 'badge-soft-danger';
                                        if($s=='Pending') $badgeClass = 'badge-soft-warning';
                                        if($s=='In Transit') $badgeClass = 'badge-soft-primary';
                    ...
                    <tfoot class="bg-light">
                        <tr>
                            ...
                            <td class="text-end fw-bold text-success fs-5 py-3 pe-4">₱<?php echo number_format($totalSales, 2); ?></td>
                        </tr>
                    </tfoot>
                    <?php endif; ?>
                </table>
