...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .card-status { border-left: 5px solid #ccc; overflow: hidden; }
    ...
    body.dark-mode .header { background-color: var(--dark-card) !important; color: var(--dark-text-main) !important; border: 1px solid var(--dark-border); }
    body.dark-mode .card,
    body.dark-mode .modal-content,
    body.dark-mode .dropdown-menu { background-color: var(--dark-card) !important; color: var(--dark-text-main) !important; border: 1px solid var(--dark-border) !important; }
    body.dark-mode .dropdown-item { color: var(--dark-text-main); }
    body.dark-mode .dropdown-item:hover,
    body.dark-mode .dropdown-item:focus { background-color: rgba(255,255,255,0.05); color: #fff; }
    body.dark-mode .text-dark { color: #fafafa !important; }
    body.dark-mode .text-muted { color: var(--dark-text-sec) !important; }
    body.dark-mode .text-primary { color: var(--border-color) !important; }
    body.dark-mode .bg-white { background-color: var(--dark-card) !important; }
    body.dark-mode .bg-light { background-color: var(--dark-bg) !important; color: #fafafa !important; border-color: var(--dark-border) !important; }
    body.dark-mode .border,
    body.dark-mode .border-end,
    body.dark-mode hr { border-color: var(--dark-border) !important; }
    body.dark-mode .btn-close { filter: invert(1); }
    body.dark-mode .form-control,
    body.dark-mode .form-select { background-color: var(--dark-bg); color: white; border-color: var(--dark-border); }
  </style>
</head>
<body>
...
<div class="sidebar d-flex flex-column flex-shrink-0 p-3" id="sidebar">
    <div class="text-center mb-4 mt-2">
      ...
      <h6 class="fw-semibold text-uppercase text-muted mb-0" style="letter-spacing: 1px; font-size: 0.75rem;">Core Transaction 3</h6>
    </div>
    <hr class="border-secondary opacity-25">
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item"><a href="user.php" class="nav-link"><i class="bi bi-grid-1x2"></i><span>Dashboard</span></a></li>
      <li class="nav-item"><a href="bookshipment.php" class="nav-link"><i class="bi bi-box-seam"></i><span>Book Shipment</span></a></li>
      <li class="nav-item"><a href="My_shipment.php" class="nav-link active"><i class="bi bi-truck"></i><span>My Shipments</span></a></li>
      <li class="nav-item"><a href="shiphistory.php" class="nav-link"><i class="bi bi-clock-history"></i><span>History</span></a></li>
      <li class="nav-item"><a href="feedback.php" class="nav-link"><i class="bi bi-chat-square-text"></i><span>Feedback</span></a></li>
    </ul>
</div>
       ...
       <div class="d-flex align-items-center gap-3">
          <div class="dropdown me-3">
            <a href="#" class="text-dark position-relative" id="notifDropdown" data-bs-toggle="dropdown" onclick="markRead()">
              ...
              <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger shadow-sm border border-white" id="notifBadge" style="display: none; padding: 0.25em 0.5em; font-size: 0.65em;">
                0
              </span>
            </a>
            <ul class="dropdown-menu dropdown-menu-end shadow-sm p-0" style="width: 320px; max-height: 480px; overflow-y: auto;">
              <li class="p-3 border-bottom fw-bold bg-light d-flex justify-content-between align-items-center">
                ...
                <small class="text-primary" style="cursor:pointer;" onclick="location.href='feedback.php'">View All</small>
              </li>
              <div id="notifList">
           ...
           <div class="dropdown">
             <a href="#" class="d-flex align-items-center text-decoration-none text-dark dropdown-toggle" data-bs-toggle="dropdown">
               <img src="<?php echo $profileImage; ?>" alt="User" class="rounded-circle border border-2 border-primary" width="40" height="40" style="object-fit:cover;">
             </a>
           ...
           <div class="form-check form-switch mb-0">
             <label class="form-check-label d-none d-sm-inline text-muted" for="userThemeToggle"><i class="bi bi-moon-stars"></i></label>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2 text-end d-grid gap-2">
                                        ...
                                        <?php if(strpos($st, 'delivered') !== false): ?>
                                            ...
                                            <?php else: ?>
                                                <button onclick="openReceiveModal(<?php echo $row['id']; ?>)" class="btn btn-outline-success btn-sm">
